...
mod tests {
    ...
    chess_test!(test_perft_fast, {
        test_case(
            "en passant discovered check 1",
            "3k4/3p4/8/K1P4r/8/8/8/8 b - - 0 1",
            4,
            10138,
        );
        test_case(
            "en passant discovered check 2",
            "8/8/8/8/k1p4R/8/3P4/3K4 w - - 0 1",
            4,
            10138,
        );
        test_case(
            "avoid illegal en passant capture 1",
            "8/5bk1/8/2Pp4/8/1K6/8/8 w - d6 0 1",
            4,
            9287,
        );
        test_case(
            "avoid illegal en passant capture 2",
            "8/8/1k6/8/2pP4/8/5BK1/8 b - d3 0 1",
            4,
            9287,
        );
        test_case(
            "en passant capture checks opponent 1",
            "8/8/1k6/2b5/2pP4/8/5K2/8 b - d3 0 1",
            4,
            13931,
        );
        test_case(
            "en passant capture checks opponent 2",
            "8/5k2/8/2Pp4/2B5/1K6/8/8 w - d6 0 1",
            4,
            13931,
        );
        test_case(
            "short castling gives check 1",
            "5k2/8/8/8/8/8/8/4K2R w K - 0 1",
            4,
            6399,
        );
        test_case(
            "short castling gives check 2",
            "4k2r/8/8/8/8/8/8/5K2 b k - 0 1",
            4,
            6399,
        );
        test_case(
            "long castling gives check 1",
            "3k4/8/8/8/8/8/8/R3K3 w Q - 0 1",
            4,
            7418,
        );
        test_case(
            "long castling gives check 2",
            "r3k3/8/8/8/8/8/8/3K4 b q - 0 1",
            4,
            7418,
        );
        test_case(
            "castling (including losing cr due to rook capture) 1",
            "r3k2r/1b4bq/8/8/8/8/7B/R3K2R w KQkq - 0 1",
            3,
            27826,
        );
        test_case(
            "castling (including losing cr due to rook capture) 2",
            "r3k2r/7b/8/8/8/8/1B4BQ/R3K2R b KQkq - 0 1",
            3,
            27826,
        );
        test_case(
            "castling prevented 1",
            "r3k2r/8/3Q4/8/8/5q2/8/R3K2R b KQkq - 0 1",
            3,
            50509,
        );
        test_case(
            "castling prevented 2",
            "r3k2r/8/5Q2/8/8/3q4/8/R3K2R w KQkq - 0 1",
            3,
            50509,
        );
        test_case(
            "promote out of check 1",
        ...
        test_case(
            "promote to give check 1",
            "4k3/1P6/8/8/8/8/K7/8 w - - 0 1",
            4,
            2661,
        );
        test_case(
            "promote to give check 2",
            "8/k7/8/8/8/8/1p6/4K3 b - - 0 1",
            4,
            2661,
        );
        test_case(
            "underpromote to check 1",
            "8/P1k5/K7/8/8/8/8/8 w - - 0 1",
            4,
            1329,
        );
        test_case(
            "underpromote to check 2",
            "8/8/8/8/8/k7/p1K5/8 b - - 0 1",
            4,
            1329,
        );
        test_case("self stalemate 1", "K1k5/8/P7/8/8/8/8/8 w - - 0 1", 4, 63);
        test_case("self stalemate 2", "8/8/8/8/8/p7/8/k1K5 b - - 0 1", 4, 63);
        test_case(
    ...
    fn test_perft_slow() {
        ...
        test_case("self stalemate 1", "K1k5/8/P7/8/8/8/8/8 w - - 0 1", 6, 2217);
        test_case("self stalemate 2", "8/8/8/8/8/p7/8/k1K5 b - - 0 1", 6, 2217);
        test_case(
            "stalemate/checkmate 1",
            "8/k1P5/8/1K6/8/8/8/8 w - - 0 1",
            7,
