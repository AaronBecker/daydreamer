...
typedef void(*option_handler)(void*, const char*);
 ...
 */
static void add_uci_option(const char* name,
        uci_option_type_t type,
...
{
    const char* option_types[] = { "check", "spin", "combo", "button", "string" };
 ...
 */
static void default_handler(void* opt, const char* value)
{
    uci_option_t* option = (uci_option_t*)opt;
...
static void handle_verbosity(void* opt, const char* value)
{
    if (!value) return;
    uci_option_t* option = (uci_option_t*)opt;
    if (value) strncpy(option->value, value, 128);
 ...
 */
static void handle_hash(void* opt, const char* value)
{
    uci_option_t* option = (uci_option_t*)opt;
    int mbytes = 0;
 ...
 */
static void handle_pawn_cache(void* opt, const char* value)
{
    uci_option_t* option = (uci_option_t*)opt;
    int mbytes = 0;
    strncpy(option->value, value, 128);
 ...
 */
static void handle_pv_cache(void* opt, const char* value)
{
    uci_option_t* option = (uci_option_t*)opt;
    int mbytes = 0;
    strncpy(option->value, value, 128);
 ...
 */
static void handle_clear_hash(void* opt, const char* value)
{
    (void) opt; (void) value;
 ...
 */
static void handle_gtb_use(void* opt, const char* value)
{
    uci_option_t* option = (uci_option_t*)opt;
 ...
 */
static void handle_gtb_path(void* opt, const char* value)
{
    uci_option_t* option = (uci_option_t*)opt;
    strncpy(option->value, value, 128);
 ...
 */
static void handle_gtb_cache(void* opt, const char* value)
{
    uci_option_t* option = (uci_option_t*)opt;
    if (!option->value) return;
    strncpy(option->value, value, 128);
 ...
 */
static void handle_gtb_scheme(void* opt, const char* value)
{
    if (!value) return;
    uci_option_t* option = (uci_option_t*)opt;
    if (value) strncpy(option->value, value, 128);
 ...
 */
static void handle_scorpio_bb_use(void* opt, const char* value)
{
    uci_option_t* option = (uci_option_t*)opt;
    if (!option->value) return;
    strncpy(option->value, value, 128);
 ...
 * appropriate option is set.
 */
static void handle_scorpio_bb_path(void* opt, const char* value)
{
    uci_option_t* option = (uci_option_t*)opt;
    strncpy(option->value, value, 128);
    int len = strlen(option->value);
 ...
 */
static void handle_book_file(void* opt, const char* value)
{
    uci_option_t* option = (uci_option_t*)opt;
    strncpy(option->value, value, 128);
...
void init_uci_options()
{
    ...
    const char* schemes[6] = { "uncompressed", "cp1", "cp2", "cp3", "cp4", NULL };
    add_uci_option("Gaviota compression scheme", OPTION_COMBO, "cp4",
            0, 0, (char**)schemes, &options.gtb_scheme, &handle_gtb_scheme);
    ...
    const char* verbosities[4] = { "low", "medium", "high", NULL };
    add_uci_option("Verbosity", OPTION_COMBO, "low",
            0, 0, (char**)verbosities, &options.verbosity, &handle_verbosity);
